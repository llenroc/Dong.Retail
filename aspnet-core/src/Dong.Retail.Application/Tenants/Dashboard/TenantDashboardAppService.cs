...
using Dong.Retail.Tenants.Dashboard.Dto;

namespace Dong.Retail.Tenants.Dashboard
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Tenant_Dashboard)]
    public class TenantDashboardAppService : RetailAppServiceBase, ITenantDashboardAppService
    {
