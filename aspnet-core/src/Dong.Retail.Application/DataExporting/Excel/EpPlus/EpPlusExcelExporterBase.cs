...
using Dong.Retail.Net.MimeTypes;
using OfficeOpenXml;

namespace Dong.Retail.DataExporting.Excel.EpPlus
{
    public abstract class EpPlusExcelExporterBase : RetailServiceBase, ITransientDependency
    {
