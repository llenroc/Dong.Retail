...
namespace Dong.Retail.Web.Areas.AppAreaName.Views.Shared.Components.AppAreaNameSideBar
{
    public class AppAreaNameSideBarViewComponent : RetailViewComponent
    {
