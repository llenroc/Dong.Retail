...
using Dong.Retail.Configuration.Host;
using Dong.Retail.Editions;
using Dong.Retail.Timing;
using Dong.Retail.Timing.Dto;
using Dong.Retail.Web.Areas.AppAreaName.Models.HostSettings;
...
namespace Dong.Retail.Web.Areas.AppAreaName.Controllers
{
    ...
    public class HostSettingsController : RetailControllerBase
    {
