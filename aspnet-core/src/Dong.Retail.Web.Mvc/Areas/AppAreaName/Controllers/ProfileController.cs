...
using Dong.Retail.Authorization.Users.Profile;
using Dong.Retail.Configuration;
using Dong.Retail.Timing;
using Dong.Retail.Timing.Dto;
using Dong.Retail.Web.Areas.AppAreaName.Models.Profile;
...
namespace Dong.Retail.Web.Areas.AppAreaName.Controllers
{
    [Area("AppAreaName")]
    [AbpMvcAuthorize]
    public class ProfileController : RetailControllerBase
    {
