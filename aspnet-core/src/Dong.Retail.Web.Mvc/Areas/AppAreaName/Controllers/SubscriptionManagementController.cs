...
using Dong.Retail.Web.Areas.AppAreaName.Models.SubscriptionManagement;
using Dong.Retail.Web.Controllers;
using Dong.Retail.Web.Session;
using PaymentViewModel = Dong.Retail.Web.Models.Payment.PaymentViewModel;

namespace Dong.Retail.Web.Areas.AppAreaName.Controllers
{
    [Area("AppAreaName")]
    [AbpMvcAuthorize(AppPermissions.Pages_Administration_Tenant_SubscriptionManagement)]
    public class SubscriptionManagementController : RetailControllerBase
    {
