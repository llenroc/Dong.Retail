...
namespace Dong.Retail.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : RetailServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("Dong.Retail", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
