...
using Dong.Retail.Web.Authentication.External.Facebook;
using Dong.Retail.Web.Authentication.External.Google;
using Dong.Retail.Web.Authentication.External.Microsoft;

namespace Dong.Retail.Web.Startup
{
    [DependsOn(
        typeof(RetailWebCoreModule))]
    public class RetailWebHostModule : AbpModule
    {
        private readonly IHostingEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public RetailWebHostModule(IHostingEnvironment env)
        {
            _env = env;
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(RetailWebHostModule).GetAssembly());
        }
