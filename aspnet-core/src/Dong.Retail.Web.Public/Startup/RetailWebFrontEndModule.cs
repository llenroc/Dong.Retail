...
namespace Dong.Retail.Web.Public.Startup
{
    [DependsOn(
        typeof(RetailWebCoreModule)
    )]
    public class RetailWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public RetailWebFrontEndModule(IHostingEnvironment env, RetailEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(RetailWebFrontEndModule).GetAssembly());
        }
    }
}
