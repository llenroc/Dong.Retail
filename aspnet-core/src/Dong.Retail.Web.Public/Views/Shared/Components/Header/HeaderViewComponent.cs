...
using Dong.Retail.Web.Public.Startup;
using Dong.Retail.Web.Session;

namespace Dong.Retail.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : RetailViewComponent
    {
